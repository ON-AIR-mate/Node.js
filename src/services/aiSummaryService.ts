...
1. 전체 대화 주제 요약 (1문장으로 간결하게 핵심 내용 정리)
2. 대화의 전반적인 감정 분석
- 전체 대화를 100%로 보고, 특정 감정에 해당하는 대화 내용의 문장 수 또는 단어 수 기준으로 비율 계산
- 기준: 문장 수, 단어 수, 글자 수 중 하나를 고정(추천: 문장 수)
- 주요 감정 3~5개를 선정
- 감정 예시: 행복/즐거움, 슬픔, 분노, 놀람, 감동, 공감, 공포, 좌절, 절망
- 감정 카테고리는 대화 특성에 맞춰 조정 가능
- 각 감정에 해당하는 대화 문장을 지정하고, 전체 대비 비율(%) 계산
- 감정 합계는 반드시 100%가 되도록 조정
- 감정 분류가 애매한 경우 가장 유사한 카테고리에 포함

응답은 반드시 다음 JSON 형식으로만 해주세요:
{
  "topicSummary": "요약 내용",
  "emotionAnalysis": "기쁨 n%, 슬픔 m%, ..."
}`;
